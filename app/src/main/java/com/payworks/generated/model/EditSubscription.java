...
public class EditSubscription {
    ...
    public EditSubscription(String type, String userID,String id, String token, String paidby, String subscriptionname, String subscriptionprice, String subscriptionshipping, String subscriptiondescription, String subscriptionbutton, String subscriptionsetupfee, String subscriptiontrialperiod, String subscriptionduration)
    {
        this.type = type;
        this.userID = userID;
        this.id = id;
